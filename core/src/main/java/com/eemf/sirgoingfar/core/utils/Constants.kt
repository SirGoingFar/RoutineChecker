...
object Constants {
    ...
    const val MINIMUM_NOTIF_TIME_TO_START_TIME_MILLIS = 50000 //notify when it's 5 minutes to a routine
    const val WAITING_TIME_BEFORE_MARKED_AS_MISSED = 1000 //wait for 5 minutes after routine has expired before marking as MISSED routine
    const val MAXIMUM_ROUTINE_DURATION_MILLIS = 1000 //all routine have a maximum execution time of 15 minutes
