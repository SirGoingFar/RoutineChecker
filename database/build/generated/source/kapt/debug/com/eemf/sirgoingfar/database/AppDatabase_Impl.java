  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Routine` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT, `desc` TEXT, `freqId` INTEGER NOT NULL, `routine_time` INTEGER, `last_routine_date` INTEGER)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS `routine_occurrence` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `routine_id` INTEGER NOT NULL, `status` INTEGER NOT NULL, `occurrence_date` INTEGER, `alarm_id` INTEGER NOT NULL, `name` TEXT, `desc` TEXT, `frequency_id` INTEGER NOT NULL, FOREIGN KEY(`routine_id`) REFERENCES `Routine`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
        _db.execSQL("CREATE  INDEX `index_routine_occurrence_routine_id` ON `routine_occurrence` (`routine_id`)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"3e217a203562e33d4859a8d292cb5176\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsRoutine = new HashMap<String, TableInfo.Column>(6);
        ...
        _columnsRoutine.put("last_routine_date", new TableInfo.Column("last_routine_date", "INTEGER", false, 0));
        ...
        final HashMap<String, TableInfo.Column> _columnsRoutineOccurrence = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsRoutineOccurrence.put("alarm_id", new TableInfo.Column("alarm_id", "INTEGER", true, 0));
        _columnsRoutineOccurrence.put("name", new TableInfo.Column("name", "TEXT", false, 0));
        _columnsRoutineOccurrence.put("desc", new TableInfo.Column("desc", "TEXT", false, 0));
        _columnsRoutineOccurrence.put("frequency_id", new TableInfo.Column("frequency_id", "INTEGER", true, 0));
    ...
    }, "3e217a203562e33d4859a8d292cb5176", "7a29137334c82018cc08ba46aa9ecb35");
